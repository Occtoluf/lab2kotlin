...
class MainActivity : AppCompatActivity() {
    ...
    override fun onOptionsItemSelected(item: MenuItem):
        ...
        if (itId == R.id.red) {
            myLayout.setBackgroundColor(ContextCompat.getColor(this,
                R.color.red))
            return true
        }
            ...
            if (!changedFont){
                text.setTypeface(
                    ResourcesCompat.getFont(this, R.font.pressstart2p_regular))
                changedFont = true
                return true
            }
            else{
                text.setTypeface(
                    ResourcesCompat.getFont(this, R.font.asimovian_regular))
                changedFont = false
                return true
            }
        }
